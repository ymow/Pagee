...
// Configure PDF.js worker within the component to avoid top-level side effects on server
    ...
    <div className="flex flex-col h-screen bg-white relative" onMouseUp={handleMouseUp}>
      ...
      <main className="flex-1 relative overflow-hidden flex justify-center bg-stone-100/30 custom-scrollbar overflow-y-auto pt-8 pb-12">
        ...
        <button
          ...
          className="fixed left-8 top-1/2 -translate-y-1/2 p-4 bg-white/80 hover:bg-white shadow-md rounded-full transition-all text-stone-400 hover:text-stone-900 z-10 disabled:opacity-30"
        >
        ...
        <button
          ...
          className="fixed right-8 top-1/2 -translate-y-1/2 p-4 bg-white/80 hover:bg-white shadow-md rounded-full transition-all text-stone-400 hover:text-stone-900 z-10 disabled:opacity-30"
        >
